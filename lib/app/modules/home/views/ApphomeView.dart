                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: GoogleFonts.montserrat(
                          textStyle: const TextStyle(
                              color: Color(0xff059f77), fontSize: 12)),
                    ),
                    Text(
        ...
        child: Column(
          children: [
            LimitedBox(
                maxHeight: 75,
                maxWidth: 75,
                child: Image.asset("assets/image/competitivas.png")),
            Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        LimitedBox(
                            maxHeight: 75,
                            maxWidth: 75,
                            child: Image.asset("assets/image/1contato.png")),
                        Padding(
                          padding: const EdgeInsets.fromLTRB(8, 12, 8, 8),
                        ...
                        Padding(
                          ...
                          child: LimitedBox(
                              maxHeight: 75,
                              maxWidth: 75,
                              child: Image.asset("assets/image/2parceria.png")),
                        ),
                        Text("2 PARCERIA",
                            style: GoogleFonts.montserrat(
                                textStyle: const TextStyle(
                        ...
                        LimitedBox(
                            maxHeight: 75,
                            maxWidth: 75,
                            child: Image.asset("assets/image/4liberacao.png")),
                        Padding(
                          padding: const EdgeInsets.fromLTRB(8, 12, 8, 8),
  ...
  slider() => Column(
        children: [
          ...
          Obx(() => Slider(
                ...
                activeColor: const Color(0xff059f77),
          ...
          Obx(() => Slider(
                ...
                max: 50,
                min: 0,
                label: "\$${controller.rating2.value.toStringAsFixed(3)}",
                onChanged: (double value2) {
                  controller.rating2.value = value2;
                },
              )),
          SizedBox(
            width: 135,
