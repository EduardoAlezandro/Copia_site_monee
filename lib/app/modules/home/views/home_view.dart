                  ...
                  Padding(
                      ...
                      child: OutlinedButton(
                        ...
                        child: LimitedBox(
                            maxWidth: 75,
                            maxHeight: 75,
                            child: Image.network("assets/image/logo.png")),
                      )),
                  Row(
                    children: [
                      Padding(
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Image.network("assets/image/logo2.png"),
                        ),
                      ],
                    ),
                    Row(
                      ...
                      child: Column(
                        children: [
                          LimitedBox(
                              maxHeight: 75,
                              maxWidth: 75,
                              child: Image.network("assets/image/contas.png")),
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                      ...
                      child: Column(
                        children: [
                          LimitedBox(
                              ...
                              maxWidth: 75,
                              child:
                                  Image.network("assets/image/negativo.png")),
                          Padding(
